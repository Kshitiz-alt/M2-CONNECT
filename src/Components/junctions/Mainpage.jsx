            ...
            <div className="m-3 flex max-sm:flex-none">
                <div className="buttons">
                    <div className='text-black flex flex-col gap-2 w-[18rem] max-sm:w-[10rem]'>
                        <input onClick={() => navigate('/LatestBollywood')} className="border rounded-full p-2 bg-gradient-to-r from-white to-gray-500 font-bold text-2xl max-sm:text-sm hover:text-3xl hover:w-[18rem] hover:bg-gradient-to-r hover:from-gray-500 hover:to-white hover:cursor-pointer" type="submit" value="Latest Bollywood"/>
